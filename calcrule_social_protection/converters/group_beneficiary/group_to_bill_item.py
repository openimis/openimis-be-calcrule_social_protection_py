...
class GroupToBillItemConverter:

    @classmethod
    def to_bill_item_obj(cls, payment_plan, group, amount):
        bill_line_item = {}
        cls._build_line_fk(bill_line_item, group)
        cls._build_code(bill_line_item, group)
    ...
    @classmethod
    def _build_line_fk(cls, bill_line_item, group):
        bill_line_item["line_id"] = group.id
        bill_line_item['line_type'] = ContentType.objects.get_for_model(group)
