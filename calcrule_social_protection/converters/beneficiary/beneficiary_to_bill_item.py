...
class BeneficiaryToBillItemConverter:

    @classmethod
    def to_bill_item_obj(cls, payment_plan, beneficiary, amount):
        bill_line_item = {}
        cls._build_line_fk(bill_line_item, beneficiary)
        cls._build_code(bill_line_item, beneficiary)
    ...
    @classmethod
    def _build_line_fk(cls, bill_line_item, beneficiary):
        bill_line_item["line_id"] = beneficiary.id
        bill_line_item['line_type'] = ContentType.objects.get_for_model(beneficiary)
